...
class TestRejestrKont(unittest.TestCase):
    ...
    def test_7_wyczysc_rejestr(self):
        konta = RejestrKont.wyczysc_rejestr()
        self.assertEqual(len(konta), 0)